...
public class Servletprueba extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>Desarrollo de aplicaciones web</p>");
            out.println("<p>Patricio Venero Medina</p>");
            out.println("<p>Diseño y Desarrollo De Software</p>");
            out.println("<p>Cuarto Semestre</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
